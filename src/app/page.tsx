...
const exampleSteps = [
  {
    source: "Persona",
    text: "reports a failed verification",
    event: "verification.failed",
    time: "T+0.00s",
  },
  {
    source: "Stripe",
    text: "reports a payout change",
    event: "payout.changed",
    time: "T+0.08s",
  },
  {
    source: "Hive",
    text: "flags a new upload",
    event: "content.flagged",
    time: "T+0.15s",
  },
  {
    source: "Veras",
    text: "links all three events to creator_123",
    event: "events.linked",
    time: "T+0.22s",
  },
  {
    source: "Veras",
    text: "prepares a review case",
    event: "case.created",
    time: "T+0.24s",
  },
  {
    source: "Platform",
    text: "receives a webhook",
    event: "webhook.sent",
    time: "T+0.31s",
  },
  {
    source: "Reviewer",
    text: "chooses the next action",
    event: "human.review",
    time: "T+1.45s",
  },
];
...
function EventCard({ source, event, tone }: (typeof inputs)[number]) {
  ...
  return (
    <div className="flex h-11 items-center justify-between gap-3 rounded-lg border border-white/[0.03] bg-[#08090b]/40 px-3 py-2 transition-all hover:border-white/[0.08] hover:bg-[#0c0d12]/60">
      ...
      <code
        className={`mt-1 block truncate font-mono text-[9px] text-neutral-500 sm:mt-0 bg-[#090a0c] border border-white/[0.02] px-1.5 py-0.5 rounded`}
      >
        {event}
      </code>
    </div>
...
export default function Home() {
  ...
  return (
    <main
      id="top"
      className="veras-dark relative min-h-screen overflow-hidden font-outfit text-neutral-100 antialiased"
    >
      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.04] bg-[#030407]/80 backdrop-blur-md">
        ...
        {menuOpen && (
          <nav
            ...
            className="border-t border-white/[0.04] bg-[#040507] px-5 py-4 md:hidden"
          ...
          >
            <div className="mx-auto flex max-w-7xl flex-col gap-0.5">
              {[
                ...
                <a
                  key={href}
                  className="focus-ring rounded-md px-3 py-2.5 text-[13px] text-neutral-400 hover:bg-white/[0.02] hover:text-white"
                  href={href}
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 pb-16 pt-20 sm:px-8 sm:pb-24 sm:pt-28 lg:px-12 lg:pb-28 lg:pt-32">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-balance text-4xl font-semibold leading-[1.08] tracking-[-0.04em] text-white sm:text-5xl md:text-6xl lg:text-7xl">
            Connect every{" "}
            <span className="veras-gradient-text">trust signal.</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-sm leading-[1.6] text-neutral-400 sm:text-base">
            Veras brings events from your moderation, identity, fraud, payments,
            support, and internal systems into one place, so you can review
            accounts, trigger workflows, and take action without writing custom
            glue code.
          </p>
            ...
            <div className="relative rounded-xl border border-indigo-500/20 bg-[#07080b] p-5 shadow-[0_0_40px_rgba(99,102,241,0.06)]">
              ...
              <div className="mt-4 flex flex-col gap-2">
                {[
                  ...
                  <div
                    key={item.label}
                    className="flex items-center justify-between rounded border border-white/[0.03] bg-white/[0.01] px-2.5 py-1.5 text-[11px] text-neutral-300"
                  >
                    <span>{item.label}</span>
                    <span className="font-mono text-[9px] text-indigo-400 font-semibold">
                      {item.step}
                    </span>
                  </div>
                ))}
            ...
            <div className="h-10 w-4 relative">
              ...
              >
                <line
                  ...
                  x2="8"
                  y2="40"
                  className="stroke-indigo-500/25 animate-flow-forward"
                  strokeWidth="2"
                />
              </svg>
            </div>
            ...
            <div className="w-full max-w-xs rounded-xl border border-indigo-500/20 bg-[#07080b] p-4 shadow-[0_0_30px_rgba(99,102,241,0.05)]">
              ...
              <div className="mt-3 grid grid-cols-2 gap-1.5 text-[11px] text-neutral-300">
                {["Receive", "Link", "Group", "Route"].map((label, index) => (
                  <div
                    key={label}
                    className="flex items-center gap-1.5 rounded border border-white/[0.03] bg-white/[0.01] px-2 py-1.5"
                  >
                    <span className="font-mono text-[9px] text-indigo-400 font-semibold">
                      0{index + 1}
                    </span>
            ...
            <div className="h-10 w-4 relative">
              ...
              >
                <line
                  ...
                  x2="8"
                  y2="40"
                  className="stroke-emerald-500/25 animate-flow-forward"
                  strokeWidth="2"
                />
              </svg>
            </div>
      ...
      <section className="relative z-10 border-y border-white/[0.03] bg-white/[0.005]">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 sm:px-8 sm:py-24 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-12">
          <SectionHeading
            eyebrow="The problem"
            title="Your stack is fragmented"
            body="Critical events are scattered across dozens of services."
          />
          ...
          <div className="space-y-4">
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={name}
                  className="flex flex-col justify-between rounded-lg border border-white/[0.03] bg-white/[0.01] p-4 transition-all hover:border-white/[0.06]"
                >
                  <div>
                    <div className="flex items-center justify-between border-b border-white/[0.03] pb-2 mb-2">
                      ...
                      <span className="font-mono text-[8px] font-bold text-amber-500/80 tracking-wide">
                        {status}
                      </span>
                    </div>
      ...
      <section
        id="product"
        className="relative z-10 mx-auto max-w-7xl scroll-mt-16 px-5 py-20 sm:px-8 sm:py-24 lg:px-12"
      >
        <SectionHeading
          eyebrow="Product"
          title="One event stream. Useful outputs."
          body="Connect the systems you already use. Turn their fragmented events into context your team and products can use."
        />

        <div className="mt-12 grid gap-4 md:grid-cols-2">
          {productOutputs.map(
            ({ number, title, description, icon: Icon, detail }) => (
              <article
                key={title}
                className="group rounded-xl border border-white/[0.03] bg-white/[0.01] p-6 transition-all hover:border-indigo-500/20 hover:bg-[#090a0e]/30"
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className="font-mono text-[9px] tracking-wider text-neutral-600 font-semibold">
                    [{number}]
                  </span>
                </div>
                ...
                <p className="mt-2.5 max-w-lg text-[13px] leading-relaxed text-neutral-400">
                  {description}
                </p>
                <div className="mt-5 flex flex-wrap gap-1.5">
                  {detail.map((item) => (
                    <span
                      key={item}
                      className="rounded border border-white/[0.03] bg-[#090a0c]/80 px-2 py-1 font-mono text-[9px] text-neutral-400"
                    >
                      {item}
                    </span>
                  ))}
        ...
        <p className="mt-6 font-mono text-[10px] text-neutral-500">
          Actions are executed through your own systems. Your team keeps the
          final decision.
        </p>
      </section>
      ...
      <section
        id="integrations"
        className="relative z-10 scroll-mt-16 border-y border-white/[0.03] bg-white/[0.005]"
      >
        <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-24 lg:px-12">
          <SectionHeading
            eyebrow="Integrations"
            title="Connect events from across your stack."
            body="Use connectors and webhooks to bring vendor and internal events into the same account context."
          />
              ...
              >
                ...
                <ul className="mt-4 space-y-2">
                  {group.items.map((item) => (
                    <li
                      key={item}
                      className="group/item flex items-center gap-2 text-[13px] text-neutral-400 transition-colors hover:text-neutral-200"
                    >
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-24 lg:px-12">
        <SectionHeading
          ...
          title="Three signals. One creator. One review-ready case."
        />
        ...
        <div className="mx-auto mt-12 max-w-3xl rounded-xl border border-white/[0.04] bg-[#050608] p-4 sm:p-6 shadow-[0_12px_40px_rgba(0,0,0,0.5)]">
          <ol className="relative space-y-1.5 before:absolute before:bottom-7 before:left-[19px] before:top-7 before:w-px before:bg-neutral-800 sm:before:left-[23px]">
            {exampleSteps.map((step, index) => (
              <li
                key={step.event}
                className="relative flex items-center gap-4 rounded-lg border border-transparent p-2 transition-colors hover:border-white/[0.03] hover:bg-white/[0.01] sm:gap-5 sm:p-2.5"
              >
                <span
                  className={`relative z-10 grid size-6 shrink-0 place-items-center rounded-full border font-mono text-[9px] sm:size-7 ${index < 3 ? "border-violet-500/20 bg-violet-500/[0.05] text-violet-400" : index < 6 ? "border-indigo-500/20 bg-indigo-500/[0.05] text-indigo-400" : "border-emerald-500/20 bg-emerald-500/[0.05] text-emerald-400"}`}
                >
                  {index + 1}
                </span>
                ...
                <div className="min-w-0 flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between sm:gap-5">
                  <div className="flex items-baseline gap-2">
                    <span className="font-mono text-[8px] text-neutral-500 shrink-0">
                      {step.time}
                    </span>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 sm:px-8 sm:py-24 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:px-12">
          <div>
            <SectionHeading
              ...
              title="One consistent interface for every event."
              body="Send different vendor events through the same small API. Attach them to the same subject, then build on the connected history."
            />
          ...
          <div className="overflow-hidden rounded-xl border border-white/[0.05] bg-[#040507] shadow-[0_30px_100px_rgba(0,0,0,0.8)]">
            ...
            <pre className="!m-0 overflow-x-auto !bg-transparent p-4 text-[11px] leading-6 sm:p-5 sm:text-[11.5px] font-mono select-none">
              <code>
                <div>
                  <span className="text-[#f47067]">await</span>{" "}
                  <span className="text-[#a5d6ff]">veras</span>.
                  <span className="text-[#d2a8ff]">events</span>.
                  <span className="text-[#d2a8ff]">ingest</span>(&#123;
                </div>
                <div className="pl-4">
                ...
                <div className="pl-8">
                  <span className="text-[#79c0ff]">type</span>:{" "}
                  <span className="text-[#a5d6ff]">&quot;creator&quot;</span>,
                </div>
                <div className="pl-8">
                ...
                <div className="pl-4">
                  <span className="text-[#79c0ff]">source</span>:{" "}
                  <span className="text-[#a5d6ff]">&quot;persona&quot;</span>,
                </div>
                <div className="pl-4">
                  <span className="text-[#79c0ff]">occurredAt</span>:{" "}
                  <span className="text-[#f47067]">new</span>{" "}
                ...
                <div className="pl-8">
                  <span className="text-[#79c0ff]">inquiryId</span>:{" "}
                  <span className="text-[#a5d6ff]">&quot;inq_456&quot;</span>
                </div>
                <div className="pl-4">&#125;</div>
                <div>&#125;);</div>
                ...
                <div className="pl-4">
                  <span className="text-[#79c0ff]">source</span>:{" "}
                  <span className="text-[#a5d6ff]">&quot;hive&quot;</span>,
                </div>
                <div className="pl-4">
                  <span className="text-[#79c0ff]">occurredAt</span>:{" "}
                  <span className="text-[#f47067]">new</span>{" "}
                ...
                <div className="pl-8">
                  <span className="text-[#79c0ff]">confidence</span>:{" "}
                  <span className="text-[#79c0ff]">0.94</span>
                </div>
                <div className="pl-4">&#125;</div>
                <div>&#125;);</div>
              </code>
      ...
      >
        ...
        <div className="mx-auto mt-12 grid max-w-4xl gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {useCases.map((item, index) => (
            <div
              key={item}
              className="group flex items-center justify-between rounded-lg border border-white/[0.03] bg-white/[0.01] p-4 text-[13px] font-medium text-neutral-300 transition-colors hover:border-white/[0.08] hover:bg-white/[0.02] hover:text-white"
            >
        ...
        <div className="relative mx-auto max-w-7xl overflow-hidden rounded-xl border border-indigo-500/10 bg-[#06070a]/80 px-6 py-14 text-center sm:px-10 sm:py-18">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-neutral-400">
              Connect your existing tools and turn fragmented events into
              review-ready context and usable workflows.
            </p>
